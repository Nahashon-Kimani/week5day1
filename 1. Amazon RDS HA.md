...
11. Set storage "General Purpose SSD (gp3)"(e.g., 20 GB).
12. Configure VPC, subnet group, etc.
13. Public access "Yes"
14. Select or create a new Security group
15. Click "Create database".
16. Note the **endpoint, port, username** and **password**
...
**Troubleshooting** 
1. **Error** Timeout or can't connect to the database - 
**Solution:** 
 - Check to confirm the database is **Available**. 
 - Modify the Security to allow access. 
...
7. Wait untill the database becomes **Available.**

## Step 5: Reboot with Multi-AZ Failover
